...
public abstract class JpaDAO<T> extends GenericDAO<T> {
	...
	public List<T> lerTodos() {
		...
		List<T> resultado = this.getEntityManager().createQuery(c)
				.getResultList();
		return resultado;
	}
	...
	public T salvar(T objeto) {
		boolean transacaoAtiva = this.getEntityManager().getTransaction()
				.isActive();
